...
globalThis.fetch=async(input,options={})=>{
 ...
 if(url.endsWith("/api/config"))return reply({chainId:61999,contract});
 ...
 if(url.endsWith("/prepare"))return reply({contract,transaction:{chainId:61999,to:consensus,data:submissionData(contract,id,body),nonce:0,type:"legacy",gas:"200000",gasPrice:"1",value:process.env.TEST_TAMPER?"1":"0"}});
